...
namespace Panacea2.NUnit
{
    ...
    [TestFixture]
    public sealed class WorkerTests_Acme_SharedContext
    {
        ...
        {
            var result = _worker.PostToAcme(Item1);
        ...
        {
            var result = _worker.PostToAcme(Item2);
        ...
        {
            var result = _worker.PostToAcme(Item3);
